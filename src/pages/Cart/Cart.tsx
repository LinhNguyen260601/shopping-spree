...
const Cart = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Giỏ Hàng Của Bạn - Shopping Spree | Xem & Thanh Toán</title>
        <meta
          name='description'
          content='Xem và quản lý giỏ hàng của bạn tại Shopping Spree. Kiểm tra sản phẩm đã chọn, cập nhật số lượng, áp dụng mã giảm giá và tiến hành thanh toán đơn giản, an toàn.'
        />
        <meta name='keywords' content='giỏ hàng, shopping cart, thanh toán, mua hàng, shopping spree' />
        <meta property='og:title' content='Giỏ Hàng Của Bạn - Shopping Spree' />
        <meta
          property='og:description'
          content='Xem và quản lý giỏ hàng của bạn tại Shopping Spree. Kiểm tra sản phẩm đã chọn và tiến hành thanh toán.'
        />
        <meta property='og:type' content='website' />
        <meta property='og:url' content={window.location.href} />
        <meta name='twitter:card' content='summary' />
        <meta name='twitter:title' content='Giỏ Hàng Của Bạn - Shopping Spree' />
        <meta name='twitter:description' content='Xem và quản lý giỏ hàng của bạn tại Shopping Spree.' />
